    ...
    label .check:
        ...
        menu:
            ...
            "No":
                ...
                call tips.reset from _call_tips_reset_1
                jump profile

        return

    label .flow:
        call tips.give from _call_tips_give_5
        ...
        kulo "First up..."
        call profile_bio from _call_profile_bio
        ...
        call profile_others from _call_profile_others
        hide kulo_slow
        ...
        call profile_basics from _call_profile_basics
        hide kulo_mid
        ...
        call profile_personality from _call_profile_personality
        hide kulo_fast

        call profile.check from _call_profile_check
