label profile_basics:
    ...
    while not section_correct:
        ...
        label .interests_1:
            ...
            menu:
                ...
                "Technical":
                    ...
                    show kulo_mid 
                    with q_fade
                    call profile_basics.interests_2 from _call_profile_basics_interests_2
                "What was that?":
                    show kulo_mid with entrance
                    kulo "That's alright. I asked..."
        ...
        label .occupation_1:
            ...
            menu:
                "Yes":
                    ...
                    call profile_basics.occupation_2 from _call_profile_basics_occupation_2
                "No":
                    $ p_temp = "None"
                "I'm a student":
                    $ p_temp = "Student"
                "What was that?":
                    show kulo_mid with entrance
                    kulo "That's alright. I asked..."
                    call profile_basics.occupation_1 from _call_profile_basics_occupation_1
        ...
        label .education_1:
            ...
            menu:
                ...
                "No":
                    ...
                    show kulo_mid 
                    with q_fade
                    call profile_basics.education_2 from _call_profile_basics_education_2
                "What was that?":
                    show kulo_mid with entrance
                    kulo "That's alright. I asked..."
                    jump profile_basics.education_1
        ...
        label .repeat:
            call profile.repeat from _call_profile_repeat
